...
<div id="job-modal" data-modal class="modal-overlay hidden">
    <div class="modal-box max-w-2xl">
        ...
        <div class="modal-footer"><button type="button" data-modal-close class="btn btn-ghost">Batal</button><button type="button" id="btn-save-job" onclick="saveJob()" class="btn btn-primary btn-save">Simpan</button></div>
    </div>
</div>
@endsection
