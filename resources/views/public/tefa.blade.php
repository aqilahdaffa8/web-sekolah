...
<div id="product-modal" data-modal class="modal-overlay hidden">
    <div class="modal-box max-w-2xl">
                    ...
                    <form id="order-form" class="mt-5 space-y-3">
                        ...
                        <div>
                            ...
                            <div class="flex gap-2 items-center">
                                <button type="button" onclick="changeQty(-1)" class="btn-secondary btn-sm w-10 h-10 p-0 justify-center text-lg">−</button>
        ...
        <div class="modal-footer">
            ...
            <button id="btn-submit-order" onclick="submitOrder()" class="btn-primary">
...
<div id="success-modal" data-modal class="modal-overlay hidden">
    <div class="modal-box max-w-sm text-center">
        <div class="p-8">
            ...
            <button data-modal-close class="btn-primary w-full">Selesai</button>
        </div>
    </div>
</div>
        ...
        <div class="product-card group cursor-pointer" onclick="openProduct(${JSON.stringify(p).replace(/"/g, '&quot;')})">
            <div class="overflow-hidden relative">
                ...
                <div class="absolute inset-0 bg-black/0 group-hover:bg-black/10 transition-all flex items-center justify-center">
                    <span class="btn-primary opacity-0 group-hover:opacity-100 transition-all translate-y-2 group-hover:translate-y-0">
                        Pesan
                    </span>
                </div>
                ${p.stock !== undefined ? `
