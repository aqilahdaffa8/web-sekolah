...
Route::get('/siswa/nilai', fn () => view('student.grades-verify'))->name('student.grades.verify');
Route::get('/siswa/nilai/hasil', fn () => view('student.grades-result'))->name('student.grades.result');
...
Route::prefix('dashboard')->name('dashboard.')->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::get('/students', fn () => view('dashboard.super-admin.students'))->name('students');
    ...
    Route::prefix('super-admin')->group(function () {
        ...
        Route::get('/students', fn () => view('dashboard.super-admin.students'));
        Route::get('/siswa', fn () => view('dashboard.super-admin.students'));
